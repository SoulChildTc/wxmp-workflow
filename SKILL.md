...
2. 查结构 + 句子节奏：打破刻板结构、排比堆砌、段落雷同，检测句子长度标准差（<5 需修复）
3. 查风格：允许平淡——用具体细节和观察代替情绪词，不要强行煽情
4. 加人味：注意人味不是情绪堆砌——用具体细节和自然节奏制造人味，比用"太牛了""太离谱了"更高级

**整体方向：** 像一个人平淡地说话，不要刻意煽情，不要用力过猛。

**量化评分（4 轮扫描后执行）：** 按特征词密度（30%）、句子长度方差（25%）、段落长度方差（15%）、具体性密度（20%）、口语化表达（10%）加权评分，1-3 分自然通过，4+ 分进入迭代修复循环，直到评分 ≤ 4 分或连续 2 轮边际收益 < 0.5 分。
